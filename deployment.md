...
* `FIRST_SUPERUSER_EMAIL`: The email of the first superuser, this superuser will be the one that can create new users.
* `FIRST_SUPERUSER_USERNAME`: The username of the first superuser.
...
* `LATEST_CHANGES`: Used by the GitHub Action [latest-changes](https://github.com/Pokeylooted/latest-changes) to automatically add release notes based on the PRs merged. It's a personal access token, read the docs for details.
